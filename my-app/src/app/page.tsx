          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className={`mb-6 ${isDark ? 'text-purple-300' : 'text-purple-800'}`}>
                Experience secure, private therapy sessions powered by MANTLE Chain technology. 
          ...
          {[
            {
              ...
              description: "End-to-end encrypted therapy sessions on MANTLE Chain"
            },
            {
